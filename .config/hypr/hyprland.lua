...
hl.config({
    general = {
        ...
        col = {
            active_border   = "rgba(232,221,181,0.7)",
...
-- Default springs
hl.curve("easy",           { type = "spring", mass = 1, stiffness = 1500, dampening = 100})
...
-- Reset waybar and sunsetr
hl.bind(mainMod .. " + SHIFT + N", hl.dsp.exec_cmd("pkill sunsetr; sunsetr &"))
